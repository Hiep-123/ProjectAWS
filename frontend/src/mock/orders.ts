...
export const mockOrders: Order[] = [
    ...
    },
    {
        ...
        status: 'Processing',   // was 'Shipped' — mapped to nearest real demo status
        totalAmount: 347.98,
        subtotal: 239.98,
        tax: 19.20,
        shippingCost: 0,
...
export const mockOrderTimelines: Record<string, OrderTimeline[]> = {
    'ORD-20240601-ABC123': [
        ...
        },
        {
            ...
            description: 'Order event published to EventBridge — async processing started',
            eventId: 'evt-002',
        },
        {
            status: 'Processing',
            timestamp: '2024-05-25T12:00:00Z',
            description: 'Inventory validated and order fulfilment confirmed',
            eventId: 'evt-003',
        },
        {
            status: 'Processing',
            timestamp: '2024-05-25T12:15:00Z',
            description: 'Order fulfilment completed — preparing for delivery',
            eventId: 'evt-004',
        },
        {
            status: 'Delivered',
    ...
    'ORD-20240602-DEF456': [
        ...
        },
        {
            ...
            description: 'Inventory validated — all items confirmed in stock',
            eventId: 'evt-008',
        },
        {
            status: 'Processing',
            timestamp: '2024-06-01T10:45:00Z',
            description: 'Order fulfilment in progress',
            eventId: 'evt-009',
        },
    ],
}

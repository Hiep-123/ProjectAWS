...
export function getStatusColor(status: string): string {
    const map: Record<string, string> = {
        ...
        inventory_updated: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400',
        email_sent: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-400',
